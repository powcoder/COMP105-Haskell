...
runTest test = do
    res <- timeout 1000000 $ (tester test) `catch` handler
...
testCases = 
    ...
    , oneArg Assignment2.transaction_to_string ('S', 100, 1104, "VTI", 1)  "Sold 100 units of VTI for 1104 pounds each on day 1" "transaction_to_string"
